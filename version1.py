...
# fetching image URL and image description from UnsplashAPI        
...
# image URL and description fetching path, renders image URL and description to HTML template

@app.route('/get_image_url', methods=['GET'])
def get_image_url_route():
    word = request.args.get('word')
    image_data = get_image_url(word)
    return jsonify({'image_url': image_data['url'], 'description': image_data['description']})
